defmodule ClienteJugador.ClienteTCP do
  @moduledoc """
  ...
  def configurar_host(host) do
    Application.put_env(:cliente_jugador, :servidor_host, host)
  end
  ...
  """
  def host_actual do
    Application.get_env(:cliente_jugador, :servidor_host, @host_default)
  end
end
